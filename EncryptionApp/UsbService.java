    ...
    private UsbSerialInterface.UsbReadCallback mCallback = new UsbSerialInterface.UsbReadCallback() {
        ...
        public void onReceivedData(byte[] arg0) {
            ...
            try {
                ...
                Log.d("data from serial", data);
                if (mHandler != null)
                    mHandler.obtainMessage(MESSAGE_FROM_SERIAL_PORT, data).sendToTarget();
            } catch (UnsupportedEncodingException e) {
                Log.d("data from serial", "Not received anthing from monitor");
                e.printStackTrace();
            }
        }
    };
    ...
    private void findSerialPortDevice() {
        ...
        if (!usbDevices.isEmpty()) {
            ...
            for (Map.Entry<String, UsbDevice> entry : usbDevices.entrySet()) {
                ...
                Log.d("USBTag", String.format("USBDevice.HashMap (vid:pid) (%X:%X)-%b class:%X:%X name:%s",
        ...
        public void run() {
            ...
            if (serialPort != null) {
                if (serialPort.syncOpen()) {
                    ...
                    Log.d("SERIAL TAG", String.valueOf(serialPort.read(mCallback)));


                   // Log.d("TEENSY READ", serialPort.read(mCallback));
    ...
    private class ReadThread extends Thread {
        ...
        public void run() {
            while(true){
                ...
                Log.d("thread read ", Integer.toString(n));
                if(n==-1){
                    System.exit(-1);
                }
                    ...
                    Log.d("n>0Tag", receivedStr);
                    mHandler.obtainMessage(SYNC_READ, receivedStr).sendToTarget();
                    Log.d("n>0Tag", receivedStr);
                    //throw new RuntimeException("This is a carsh for n>0");
